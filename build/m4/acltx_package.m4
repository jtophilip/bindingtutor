dnl @synopsis ACLTX_PACKAGE(PACKAGENAME,CLASSNAME,VARIABLETOSET[,ACTION-IF-FOUND[,ACTION-IF-NOT-FOUND]])
dnl
dnl This macro try to compile a latex document using class CLASSNAME
dnl and including package PACKAGENAME and set VARIABLETOSET to yes or
dnl no If ACTION-IF-FOUND (and ACTION-IF-NOT-FOUND) are set to the
dnl right action
dnl
dnl @category LaTeX
