function [Frac, MTfree, Abound] = MAP_bind(MTtot, Atot, KM, KA)
...
% to an MT-bound A with a disassociatio constant of KA
...
Afree = subs(A1(1), {at mtt km ka}, {Atot MTtot KM KA});
AB = Atot - Afree;
Abound = real(AB);
