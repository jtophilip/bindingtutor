...
Make sure that you have downloaded and installed the MatLab Compiler 
Runtime and the Visual C Runtime (if you're running Windows). If you're 
not sure whether you've downloaded and installed these two programs, 
download them from our downloads page (insert link) and run them again.
